...
function [u1 u2 tax a1 a2] = binocular_rivalry_anim3
close all;
...
% adapted to my version of Shpiro et al
taua = 200;
beta = 1;
%g = 0.;%1; %
g = .3;%.5;
...
for t=1:time-1 
    ...
    n1(t+1) = n1(t)+dt*(-n1(t)/tauN+sig/sqrt(dt)*sqrt(2/tauN)*randn(1));
    n2(t+1) = n2(t)+dt*(-n2(t)/tauN+sig/sqrt(dt)*sqrt(2/tauN)*randn(1));
...
plot(tax/100,u1,'r',tax/100,u2,'b',tax/100,a1,'r--',tax/100,a2,'b--')
%legend('u1','u2','a1','a2')
%xlabel('input strength I1=I2')
