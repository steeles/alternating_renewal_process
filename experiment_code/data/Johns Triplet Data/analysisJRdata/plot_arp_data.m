% would be better if i added arguments dim for which dimensions should be
% plotted by this program into subplot positions
% also output argument h with figure handle, along with input in clase i
% wanted to feed different structs to the same graph or something
