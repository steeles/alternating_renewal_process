...
% results should contain BUF, BUFarp, rSquared, g1_pars, g2_pars,
...
[error rSquared BUFarp] = compare_buildup_functions2([g1_pars;g2_pars], ...
    BUF, tax);

results = v2struct(BUF, BUFarp, tax, rSquared, g1_pars, g2_pars, ...
    nWindows, durs1, durs2,durs);
