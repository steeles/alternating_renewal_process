...
\title[Alternating renewal process describes buildup]{From one to many (and back again): an alternating renewal process describes the buildup of perceptual grouping}
...
\begin{wrapfigure}{R}{0.6\textwidth}
	\centering
	  ...
	  \sidesubfloat[]{\label{fig:a}\includegraphics[width=0.65\textwidth]{../percepts&distributions&BUF}} \\
	  \vspace{20 pt}
      \sidesubfloat[]{\label{fig:b}\includegraphics[width=0.75\textwidth]{../monte_carlo_convergence}}
...
\begin{wrapfigure}{L}{0.6\textwidth}
	...
	\vspace{20 pt}
	\sidesubfloat[]{\label{fig:b}\includegraphics[width=.7\textwidth]{BUFs_hists_lowadapt}} 
