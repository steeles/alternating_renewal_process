...
function [g fval] = find_gamma_fit2(samples,bPlot)

k = size(samples);
nDistributions = k(1); % rows in the samples array, columns in the pars array

g(2,nDistributions) = 0;


for ind = 1:nDistributions
