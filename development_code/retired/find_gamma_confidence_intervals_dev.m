function [min_Alpha,betaAtMinAlpha,max_Alpha,betaAtMaxAlpha] = ...
    find_gamma_confidence_intervals_dev(alpha,beta,x,fval,g,bPlot)
...
if ~exist('bPlot','var')
    ...
    outside_confidence_interval99 = likelihood_ratio>100;
    ...
    if bPlot
        ...
        imagesc(alphaRange,betaRange,outside_confidence_interval99); colorbar
        hold on; plot(g(1),g(2),'ro'); set(gca,'YDir','Normal')
    end
