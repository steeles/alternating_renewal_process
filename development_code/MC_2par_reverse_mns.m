...
randBounds = [1 5]; % sets minimum value and range for shape parameter
bSmall_scale = 1; %
...
%        [Durs(((tInd-1) * nSwitches+1):(tInd*nSwitches) ,:)]=...
    ...
    if bPlot
        ...
        hg1 = text(12,120,sprintf('true parameters: %1.2f, %1.2f',g1(1),g1(2)));
        set(hg1,'Color',[.3 .3 .3],'FontSize',18)
        hg2 = text(12,100,sprintf('found parameters: %1.2f, %1.2f',...
        ...
        hs1 = text(14,120,sprintf('true parameters: %1.2f, %1.2f',g2(1),g2(2)));
        set(hs1,'Color',[.3 .3 .3],'FontSize',18)
        hs2 = text(14,100,sprintf('found parameters: %1.2f, %1.2f',...
    ...
    [tot_winning1(ind) pvals1(ind) ksstat1(ind)] = ...
        goodness_of_gamma_fit(durs1S,bufpars_fit(1:2),bPlot);
    end
    ...
    [tot_winning2(ind) pvals2(ind) ksstat2(ind)] = ...
        goodness_of_gamma_fit(durs2S,bufpars_fit(3:4),bPlot);
    end
end

proportionGoodFits = 1-mean([tot_winning1 tot_winning2])
mn_pval = mean([pvals1 pvals2])
mn_distance = mean([ksstat1 ksstat2])