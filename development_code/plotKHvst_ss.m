function [k2t k2tv] = plotKHvst_ss(rawdata,filename)
%   Nov 19, 2011
...
%k1d=rawdata{3}.Down;k1u=rawdata{3}.Up;
%k2d=rawdata{4}.Down;k2u=rawdata{4}.Up;
...
for k=1:nk1 
    ...
    % parse the parentheses please-- everything is in seconds, really!
...
k1dt=k1dt+(k1d(1,5)-firstmin)*60; % if firstmin=k1d(1,5), this = 0;
